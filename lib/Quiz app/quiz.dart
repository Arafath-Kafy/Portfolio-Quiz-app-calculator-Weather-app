...
import 'package:labfinal/Quiz%20app/quizstart.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Future<void> saveScore(int score) async {
    List<String>? scoresStringList =
        sharedPreferences?.getStringList('savedScores') ?? [];
    List<int> scores = scoresStringList.map((e) => int.parse(e)).toList();
    scores.add(score);
    List<String> updatedScoresStringList =
    scores.map((e) => e.toString()).toList();
    await sharedPreferences?.setStringList('savedScores', updatedScoresStringList);
  }
        ...
        children: [
          Container(
            ...
            child: ElevatedButton(
              ...
              style: ButtonStyle(
                backgroundColor:
                MaterialStateProperty.all<Color>(Colors.orangeAccent), // Change the button color here
              ),
            ),
          ),
        ],
